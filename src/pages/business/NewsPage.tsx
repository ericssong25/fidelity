  ...
  return (
    <div className="flex-1 p-5 pb-24 md:pb-8 overflow-y-auto flex items-center justify-center">
      <div className="text-center">
        <h1 className="font-extrabold text-[#12173B] text-xl mb-4">Noticias</h1>
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#B1A9E5]/10">
          ...
          <h2 className="font-bold text-[#12173B] text-lg mb-2">Próximamente</h2>
          <p className="text-[#B1A9E5] text-sm">
            Estamos trabajando en un sistema de noticias para mantener informados a tus clientes. ¡Pronto!
          </p>
        </div>
      </div>
    </div>
